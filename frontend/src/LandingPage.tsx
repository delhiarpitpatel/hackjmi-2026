...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-app-main dark:bg-[#121212] text-app-primary dark:text-[#F8FAFC]">
      {/* Navigation */}
      <header className="fixed top-0 w-full z-50 bg-app-main/70 dark:bg-[#121212]/70 backdrop-blur-md px-6 py-4 flex items-center justify-between">
      ...
      {/* Hero */}
      <section className="pt-32 pb-20 px-6 text-center bg-app-main dark:bg-[#121212]">
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
          Synchronize Your Vitality with AI-Driven Intelligence
        </h1>
        <p className="mt-4 text-lg max-w-xl mx-auto text-app-primary dark:text-[#F8FAFC]">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button className="px-8 py-4 bg-app-card dark:bg-[#1E293B] text-app-accent dark:text-[#F8FAFC] border-2 border-app-accent rounded-full hover:bg-indigo-50 transition flex items-center justify-center gap-2">
      ...
      <section id="features" className="px-6 py-20">
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="bg-[#F3EFE0] dark:bg-[#1E293B] rounded-2xl p-8 shadow-lg flex flex-col items-center text-center">
            <Fingerprint className="w-10 h-10 text-indigo-600 mb-4" />
            <h3 className="font-semibold text-lg">Biometric UPI</h3>
            <p className="mt-2 text-sm text-[#1E293B] dark:text-[#F8FAFC]">
              Secure payments up to ₹5,000 using FaceID/Fingerprint.
            </p>
          </div>
          <div className="bg-[#F3EFE0] dark:bg-[#1E293B] rounded-2xl p-8 shadow-lg flex flex-col items-center text-center">
            <Activity className="w-10 h-10 text-indigo-600 mb-4" />
            <h3 className="font-semibold text-lg">Predictive Risk Modeling</h3>
            <p className="mt-2 text-sm text-[#1E293B] dark:text-[#F8FAFC]">
          ...
          <div className="bg-[#F3EFE0] dark:bg-[#1E293B] rounded-2xl p-8 shadow-lg flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold text-lg">AI Nutrition & Fitness</h3>
            <p className="mt-2 text-sm text-[#1E293B] dark:text-[#F8FAFC]">
          ...
          <div className="bg-[#F3EFE0] dark:bg-[#1E293B] rounded-2xl p-8 shadow-lg flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold text-lg">Zero-Click SOS</h3>
            <p className="mt-2 text-sm text-[#1E293B] dark:text-[#F8FAFC]">
      ...
      {/* Trust & Compliance */}
      <section id="security" className="px-6 py-20 bg-app-card dark:bg-[#1E293B]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl font-semibold mb-4">Trust & Compliance</h2>
          <p className="text-[#1E293B] dark:text-[#F8FAFC] mb-8">
      ...
      {/* Footer */}
      <footer className="px-6 py-8 text-center bg-app-card dark:bg-[#1E293B]">
